...
1. 기본적으로 데이터 디렉토리당 하나의 복구 스레드가 사용됩니다.
...
1. 기본적으로 하나의 파티션이 생성됩니다.
10. quota.producer.default
설명:
